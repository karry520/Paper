R-CNN系列算法是一个很庞大的算法簇，Ross Girshick发表\textit{Rich Feature Hierarchies for Accurate Object Detection and Semantic Segmentation}\cite{rcnn}一文以来桃李满天下。在此，我们只介绍与R-CNN关系最亲密的算法，他们的发展顺序如图\ref{rcnn-dev}：
\begin{uscfigure}
