R-CNN 其实是一个很大的家族，Ross Girshick发表\textit{Rich Feature Hierarchies for Accurate Object Detection and Semantic Segmentation}\cite{rcnn}一文以来桃李满天下。在此，我们只探讨R-CNN直系亲属，他们的发展顺序如图\ref{rcnn-dev}：
\begin{uscfigure}
